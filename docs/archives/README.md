# Archives — Code Reviews

Ce dossier contient les anciennes revues de code qui ont été résolues.
...
## Nouvelles Corrections (Session 2024-12-19)
...
6. ✅ Règles CSS pour checkboxes imbriquées
7. ✅ Création du FolderPrintModal
8. ✅ Ajout de l'option "Print in color" dans le modal

## Document Actuel

Voir **ETAT_DES_LIEUX.md** pour l'état actuel du projet.
